...
<body>
            ...
            <div class="col-lg-12">
                ...
                <div style="padding-bottom:0px;" class="row header">
                    ...
                    <div class="col-lg-6 col-xs-6">
                        ...
                        <p>This Web Application uses the IBM's speech synthesis capabilities to convert English or Spanish text to an audio signal.The audio is streamed back to the client with minimal delay.</p>
                    </div>
                    <div class="col-lg-4 col-xs-4">
                        <h4>Group 4</h4>
                         <p>Yiwei Shen   &nbsp;&nbsp;	214446221</p>
                       	 <p>Shivani     	  &nbsp; &nbsp; 214413369</p>
                     	 <p>Sandeep Sehrawat &nbsp; 214359406</p>
                    </div>
                </div>
            </div>
        </div>
 ...
 The converting has a bit of delay, please be patient.</small></span>
                                </div>
                            </div>
